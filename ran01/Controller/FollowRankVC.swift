...
class FollowRankVC: UIViewController {
    ...
    func _getAllRanking() {
        DataService.instance.getCurrentUserId { (userId) in
            ...
            DataService.instance.getAllFollowUserFor(userId: userId, handler: { (returnedFollowUser) in
                
                let followUserIdArray = returnedFollowUser
                
                DataService.instance.getAllRankingForFollowUser(followUserIdArray: followUserIdArray, handler: { (returnRanking) in
...
extension FollowRankVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "followRankingItemCell", for: indexPath) as? FollowRankingItemCell else {
