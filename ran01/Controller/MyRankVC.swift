...
class MyRankVC: UIViewController {
...
//            let favoritsAllay: [String] = []
            ...
            DataService.instance.getAllRankingForUser(userId: userId) { (returnRanking) in
...
extension MyRankVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "myRankingItemCell", for: indexPath) as? MyRankingItemCell else {
